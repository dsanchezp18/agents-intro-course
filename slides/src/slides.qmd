...
- Dont' paste stuff from webpages you don't trust into the agent, it may be malicious
...
![Giovanni Domenico Tiepolo, *The Procession of the Trojan Horse in Troy* (1773), public domain](images/trojan_horse.jpg){height=1.6in}
...
- EcuDataMCP: allows to easily consult the Ecuadorian governemnt database
