...
Included here as illustrative examples of what a Claude Code skill for
empirical research can look like:

- `replication-package/` — assembles a submission-ready replication package
  (AEA DCAS / openICPSR standard).
- `respond-to-referees/` — drafts a response-to-referees document from a
