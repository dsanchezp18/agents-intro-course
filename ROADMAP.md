...
0. [ ] Welcome slide: needs real content (currently a skeleton placeholder)
...
3. [x] Cybersecurity: do's and don'ts
4. [~] Mechanics and cost models
...
6. [~] Usages (the core, hands-on section)
   ...
   2. [ ] Literature review
   3. [ ] Writing review
   4. [ ] Skills and agents from modern economists: include Paul
          Goldsmith-Pinkham and the Santana material as examples
...
- [ ] Tokens explainer: new slide inside section 4, using the cake-and-slices
      analogy (weekly allowance = whole cake, each use = a slice, budget
      slices across the week)
- [ ] Local models: short slide inside section 3 (Cybersecurity), privacy
      angle. What researchers handling restricted admin microdata are
      actually doing with on-device/local LLMs instead of sending data to a
      cloud API
